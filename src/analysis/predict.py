...
def ORFGenerator(sequ):
    '''
    ORFGenerator(sequ)
    Scans both strands of the give sequence and yields the longest subsequence
    ...
    while 1:
        ...
        if max_match[1]:
            ...
            qout.put(sequ.Sequence(name.strip(), seq.seq, defline=defline,
                     original=seq.original, type=seq.type, start=seq.start,
